---
title: "Projekt Fredrikan vuosi 2025 – ja katse vuoteen 2026"
url: "/yhteenveto-2025-katse-2026/"
date: "2025-12-14"
images: ["/img/2025-12-julmiddag-01.jpeg"]
author: ['Robert']
categories: ['AI']
tags: ['suomi', 'yleiskatsaus','svenska kulturfonden','sls','kotus', 'AI', 'projekt fredrika']
toc: false
draft: false
_build:
  list: true
...
Projekt Fredrikan tavoitteena on parantaa Wikipedian kattavuutta koskien Suomen ruotsalaisuutta, ruotsiksi, suomeksi ja muilla kielillä. Projekti toimii Wikipedia-projektisivujen kautta useilla kielillä sekä rekisteröidyn yhdistyksen Projekt Fredrika rf:n kautta. Lisätietoja suomeksi: [fi:Wikipedia:Projekt_Fredrika](https://fi.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika), ja vielä tarkemmin ruotsiksi: [sv:Wikipedia:Projekt_Fredrika](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika).
...
"Ruoki AI-lohikäärmettä" oli yksinkertaisesti Wikipedian parantamista metodologialla, jossa käytämme tekoälyä ruokkimaan tekoälyä. Rakensimme työkaluja, jotka ehdottavat Wikipedia-muokkauksia valittujen lähteiden perusteella. Tämä seurasi [Kajn esitystä syksyllä 2024](https://projektfredrika.fi/fredrika-matar-ai-draken/).

![Kaj pitämässä esitystä](/img/2025-12-mata-ai-draken.jpeg)
...
Lisätietoja projektisivuilla [Wikipedia:Projekt_Fredrika/Mata_AI-draken](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/Mata_AI-draken) ja [Wikipedia:Projekt_Fredrika/Yle](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/Yle).

## 2. Huumoriryhmä KAJ

Kun kiinnostus suomenruotsalaiseen huumoriryhmään KAJ räjähti helmikuussa 2025 (KAJn voitettua Melodifestivalenin ja tultua Ruotsin edustajaksi Euroviisuihin), näimme kultaisen tilaisuuden jakaa tietoa ruotsinkielisestä Suomesta kansainväliselle yleisölle. Melodifestivalenin aikana KAJn Wikipedia-artikkelien lukukerrat [ruotsiksi](https://sv.wikipedia.org/wiki/Kaj_(humorgrupp)) ja [suomeksi](https://fi.wikipedia.org/wiki/Kaj_(yhtye)) kolmisatakertaistuivat, ja [Vöyrin](https://sv.wikipedia.org/wiki/V%C3%B6r%C3%A5) artikkeli sai yhdeksänkymmentä kertaa enemmän katselukertoja.

Vuoden 2025 alussa KAJlla oli kaksi vaatimatonta Wikipedia-artikkelia, joissa oli paljon parantamisen varaa. Koordinoimme Vöyrin kunnan kanssa ja saimme rahoitusta [Harry Schaumans stiftelseltä](https://www.hss.fi/) työhön.

Parannimme KAJn artikkelia, loimme ala-artikkeleita heidän teoksistaan (katso [navigaatiolaatikko](https://sv.wikipedia.org/wiki/Mall:KAJ_(humorgrupp))), lisäsimme kuvia ja ääntämisäänteitä (katso [commons](https://commons.wikimedia.org/wiki/Category:KAJ)) ja parannimme liittyviä artikkeleita kuten [Vöyri](https://sv.wikipedia.org/wiki/V%C3%B6r%C3%A5) ja suomenruotsalainen musiikki (katso [navigaatiolaatikko](https://sv.wikipedia.org/wiki/Mall:Svenska_musikgrupper_i_Finland)). Wikipedia-yhteisö loi yhteensä 30 kieliversiota KAJ-artikkelista ennen Eurovisioita – toivomme, että niistä tuli parempia merkittävästi parannetun sisällön ansiosta, jonka teimme saataville [ruotsin-](https://sv.wikipedia.org/wiki/Kaj_(humorgrupp)), [suomen-](https://fi.wikipedia.org/wiki/Kaj_(yhtye)) ja [englanninkielisissä](https://en.wikipedia.org/wiki/KAJ_(group)) versioissa.

Lisätietoja [KAJ-blogissamme](https://projektfredrika.fi/kaj-pa-wikipedia/) ja projektisivulla [Wikipedia:Projekt_Fredrika/KAJ](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/KAJ).

![KAJ Commonsissa](/img/2025-12-12-KAJ-commons.jpg)
...
![Tilastot KAJ-artikkelien katselukerroista](/img/kaj-dagliga.png)
...
Sivuhuomautuksena: Ruotsalainen startup [Lovable](https://lovable.dev/) on nopeimmin kasvava yritys koskaan – se on saavuttanut 100 miljoonan euron ARR:n lyhyimmässä ajassa koskaan.

Lisätietoja projektisivuilla [Wikipedia:Projekt_Fredrika/SLS-Författare-1809](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/SLS-F%C3%B6rfattare-1809), [SLS-Författare-1917](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/SLS-F%C3%B6rfattare-1917) ja [SLS-Författare-1945](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/SLS-F%C3%B6rfattare-1945), sekä koodi osoitteessa [github.com/projekt-fredrika/sls-forfattare](https://github.com/projekt-fredrika/sls-forfattare).

![Kirjailijamateriaalin esikäsittely Cursorissa](/img/2025-12-forfattare-cursor.jpeg)
...
![Lovable-työkalu kirjailijoille](/img/2025-12-25-lovable.jpeg)
...
Toinen apuraha Svenska kulturfondenilta oli erilainen: Wikidata-lekseemien parantaminen [Stora finsk-svenska ordbookenilla](https://sprakinstitutet.fi/ordbocker/stora-finsk-svenska-ordboken/) (SuRu, Suuri suomi-ruotsi-sanakirja). Saimme idean siitä, että olimme aiemmin syöttäneet murresanoja [Ordbok över Finlands svenska folkmålista](https://sprakinstitutet.fi/ordbocker/ordbok-over-finlands-svenska-folkmal/) (Suomen ruotsalaisten murteiden sanakirja) yhteistyössä [Kotimaisten kielten keskuksen](https://sprakinstitutet.fi/) kanssa.

Koko sanakirjan heijastaminen [Wikidatan lekseemirakenteeseen](https://www.wikidata.org/wiki/Wikidata:Lexicographical_data) on valtava urakka – kirjassa on yli 100 000 hakusanaa. Valitsimme kaksi aluetta: yleisimmät hakusanat Google Analyticsin mukaan ja Suomi-spesifiset sanat, jotka on merkitty "Suom" sanakirjassa (esim. bergsråd/vuorineuvos). Vaikea ja mielenkiintoinen tehtävä monimutkaisine Wikidata-rakenteineen.

Lisätietoja projektisivulla [Wikipedia:Projekt_Fredrika/Suru](https://sv.wikipedia.org/wiki/Wikipedia:Projekt_Fredrika/Suru) ja koodi osoitteessa [github.com/projekt-fredrika/kotus-suru](https://github.com/projekt-fredrika/kotus-suru).

![Jääkäri SuRussa](/img/2025-12-12-suru-jagare.jpeg)

*Sana [jääkäri](https://kaino.kotus.fi/suomi-ruotsi/?p=qs-article&suru_id=SURU_4daac4a1ef361220e24d5724992a4e76&list_id=1&keyword=j%C3%A4%C3%A4k%C3%A4ri&word=j%C3%A4%C3%A4k%C3%A4ri) on merkitty SuRussa "hist Suom" sanan Suomi-spesifisen merkityksen vuoksi. Kuvakaappauksessa näkyy myös kehittämämme työkalu, joka näyttää SuRu-sanan vastaavan lekseemin Wikidatassa – mikä helpottaa käännösten linkittämistä Wikidatassa.*

![Jääkäri Wikidatassa](/img/2025-12-12-suru-jagare-wikidata.jpeg)

*Suomenkielisen "jääkäri"-lekseemin koodi Wikidatassa on [L1449014](https://www.wikidata.org/wiki/Lexeme:L1449014). Käännös on ruotsinkielisen "jägare"-lekseemin toinen merkitys, katso [L51565#S2](https://www.wikidata.org/wiki/Lexeme:L51565#S2).*
...
Katso Kajn esitys Lontoossa YouTubessa: [Saving the World by feeding the AI Dragon with unbiased open data / Kaj Arnö @ SOOCon25 London](https://projektkateryna.netlify.app/saving-world-with-ai-dragon/). Projektin verkkosivusto elää edelleen osoitteessa [projektkateryna.netlify.app](https://projektkateryna.netlify.app).

# Mitä haluamme tehdä vuonna 2026?

## SLS: Biografiskt lexikon ja muuta

Suunnittelemme jatkavamme Biografiskt lexikon för Finlandilla ([blf.fi](http://blf.fi)) ainakin kahdessa paketissa. Haluamme myös pitää "muokkausjuhlia" useammista SLS:n kirjoista – ottaa kirjallisia tekstejä ja heijastaa niitä Wikipediaan. Tähtäämme muun muassa [kirjoihin Westermarckista](https://westermarck.sls.fi/sv/) ja [Suomenruotsalaiseen antifasismiin](https://www.sls.fi/publications/finlandssvensk-antifascism/).

## Svenska kulturfonden: Ruoki tekoälylohikäärmettä 2

Olemme hakeneet rahoitusta päivitetylle 2026-versiolle raportista ["Ruotsinkielinen Suomi Wikipediassa" vuodelta 2020](https://projektfredrika.fi/det-svenska-finland-pa-wikipedia/). Tekoälyllä voimme tehdä sen nopeammin ja kattavammin. Ja ennen kaikkea: haluamme tunnistaa aukot – mitkä osat ruotsinkielisestä Suomesta ovat huonosti katettuja?

## Englanninkieliset artikkelit

Tekoäly harjoittelee vahvasti englanninkielisellä materiaalilla. Siksi suomenruotsalaisilla, jotka ovat tavalla tai toisella vaikuttaneet maailmanhistoriaan – [Westermarck](https://en.wikipedia.org/wiki/Edvard_Westermarck), [Nordenskiöld](https://en.wikipedia.org/wiki/Adolf_Erik_Nordenski%C3%B6ld), [Alma Pihl](https://sv.wikipedia.org/wiki/Alma_Pihl) – pitäisi olla kunnolliset englanninkieliset Wikipedia-artikkelit. Kyse on näkyvyydestä siellä, mistä tekoälymallit saavat tietonsa.
